...
[![types](https://img.shields.io/npm/types/idkit.svg)](https://www.npmjs.com/package/idkit)
[![license](https://img.shields.io/npm/l/idkit.svg)](./LICENSE)
...
```bash
npm install idkit
# or: pnpm add idkit  /  yarn add idkit  /  bun add idkit
```

## Random ids

```ts
import { nanoid, customAlphabet } from "idkit";
...
```ts
import { ulid, monotonicFactory, decodeTime, isUlid } from "idkit";
